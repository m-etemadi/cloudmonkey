import admin from '../assets/images/icons/admin-icon.png';
import bill from '../assets/images/icons/bill-icon.png';
import form from '../assets/images/icons/form-icon.png';
import hardware from '../assets/images/icons/hardware-icon.png';
import mobile from '../assets/images/icons/mobile-icon.png';
import payment from '../assets/images/icons/payment-icon.png';

const cardsData = [
  {
    icon: mobile,
    titleBlack: 'Native Mobile',
    titleRed: 'App Development',
  ...
  {
    icon: form,
    titleBlack: 'User Friendly Booking',
    titleRed: 'and Reservation Forms',
  ...
  {
    icon: admin,
    titleBlack: 'Comprehensive',
    titleRed: 'Administration Portal',
  ...
  {
    icon: bill,
    titleBlack: 'Automated Invoicing',
    titleRed: 'Solutions',
  ...
  {
    icon: payment,
    titleBlack: 'Secure Online',
    titleRed: 'Payment Integration',
  ...
  {
    icon: hardware,
    titleBlack: 'Hardware Access',
    titleRed: 'Device Solution',
